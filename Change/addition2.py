...
def lizard_atp(mesh, lizard, movements):
    ...
    while len(movements) > 0:
        ...
        if operation == 'a':
            if adding:
                print(f"Adding strip with movements: {to_add_movements}") # TOHMA's EDIT
                lizard = add_strip_lizard_2(mesh, lizard, to_add_movements)
                print(f"Lizard after add_strip_lizard_2: {lizard}") # TOHMA's EDIT
                to_add_movements = ''
            adding = not adding
            ...
            if adding:
                ...
                if operation == 'p':
                    print(f"Pivoting lizard: {lizard}") # TOHMA's EDIT
                    lizard = lizard_pivot(mesh, *lizard)
                    print(f"Lizard after pivot: {lizard}") # TOHMA's EDIT
                elif operation == 't':
                    print(f"Turning lizard: {lizard}") # TOHMA's EDIT
                    lizard = lizard_turn(mesh, *lizard)
                    print(f"Lizard after turn: {lizard}") # TOHMA's EDIT
    
    # TOHMA's EDIT: Update the vertices in the mesh 
    updated_vertices = {vkey: mesh.vertex_coordinates(vkey) for vkey in mesh.vertices()}
    mesh.update_default_vertex_attributes(updated_vertices)
...
def add_strip_lizard_2(mesh, lizard, movements):
    ...
    body_right = body # TOHMA's EDIT: Initialize body_right to avoid reference before assignment
