...
wandb.init(project="dqn-mesh-environment-simplified", entity="string-rl")
...
# Combine callbacks
callback = CallbackList([observation_callback, episode_logging_callback, stop_callback, reward_callback, eval_callback, wandb_callback])
