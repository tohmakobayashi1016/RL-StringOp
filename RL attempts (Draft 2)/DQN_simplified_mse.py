...
from Mesh_Environment_simplified_string_mse import MeshEnvironment
...
class WandbLoggingCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        # Compute MSE using torch's built-in mse_loss function
        ...
        wandb.log({
            ...
            'mse_loss': mse.item()  # Log the cross-entropy loss
        })
...
initial_mesh = r'C:\Users\footb\Desktop\Thesis\String-RL\Output\meaningful\ata.json'

# Path to the terminal mesh JSON file
terminal_mesh_json_path = r'C:\Users\footb\Desktop\Thesis\String-RL\Output\meaningful\atat.json'
...
# Log file path
log_file = 'observation_history_STRING_MSE_ATA_5_GAMMA_1.0.csv'
episode_log_file = 'episode_rewards_STRING_MSE_ATA_5_GAMMA_1.0.csv'
...
# Save the model
model.save("DQN_simplified_model_STRING_MSE_ATA_5_GAMMA_1.0")
