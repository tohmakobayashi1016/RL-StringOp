...
class MeshEnvironment(gym.Env):
    ...
    def calculate_reward(self, done):
        ...
        current_rmse = sqrt(sum((t-c)**2 for t,c in zip(terminal_histogram, current_histogram)) / len(terminal_histogram))
        #^ take squareroot of this shiyt
        ...
        reward = current_rmse + time_step_penalty
