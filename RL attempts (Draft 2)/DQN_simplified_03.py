...
from Mesh_Environment_simplified_mse import MeshEnvironment
...
class WandbLoggingCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        obs_input = {
            ...
            'levenshtein_distance': torch.tensor([obs['levenshtein_distance']], dtype=torch.float32),
            'mesh_distance': torch.tensor([obs['mesh_distance']], dtype=torch.float32)
        }
