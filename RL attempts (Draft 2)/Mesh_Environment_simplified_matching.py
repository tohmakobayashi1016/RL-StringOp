...
Reward function: Matching letters
...
class MeshEnvironment(gym.Env):
    ...
    def calculate_reward(self, done, truncated):
        ...
        terminal_string = ['ata'] # Examplle target string
        ...
        if done or truncated:
            ...
            if identical_to_initial:
                ...
                histogram_change = -time_step_penalty*self.max_steps
        ...
        reward = time_step_penalty + matching_reward + histogram_change
