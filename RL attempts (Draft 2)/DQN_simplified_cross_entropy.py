...
from Mesh_Environment_simplified_crossentropy import MeshEnvironment
...
class WandbLoggingCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        current_histogram = current_histogram / current_histogram.sum()  # Normalize to get probabilities

        # Compute cross-entropy loss
        target_class_index = self.terminal_histogram.unsqueeze(0).argmax(dim=1)  # Treat terminal histogram as class labels
        cross_entropy_loss = F.cross_entropy(current_histogram.unsqueeze(0), target_class_index)
        ...
        wandb.log({
            ...
            'cross_entropy_loss': cross_entropy_loss.item()  # Log the cross-entropy loss
        })
...
terminal_mesh_json_path = r'C:\Users\footb\Desktop\Thesis\String-RL\Output\meaningful\atptpta.json'
...
# Log file path
log_file = 'observation_history_CE_ATPTPTA_8.csv'
episode_log_file = 'episode_rewards_CE_ATPTPTA_8.csv'
...
# Save the model
model.save("DQN_simplified_model_CE_ATPTPTA_8")
