...
String feature: Levenshtein distance

Reward function: Mean squared error (MSE)
...
class MeshEnvironment(gym.Env):
    ...
    def step(self, action):
        ...
        try:
            ...
            print(f"Step {self.current_step + 1}: Action string - {self.action_string[0]}")
    ...
    def calculate_reward(self, done, truncated):
        ...
        # Distance-based rewards (Levenshtein)
        # mse = (levenshtein_distance)
        ...
        if done or truncated:
            ...
            if identical_to_initial:
                ...
                histogram_change = -2.0
            else:
                histogram_change = -time_step_penalty*self.max_steps + levenshtein_distance*self.max_steps
        ...
        reward = -levenshtein_distance + time_step_penalty + histogram_change
    ...
    def is_terminal_state(self):
        ...
        # Make SURE to toggle match string off for backward sequence check
        return done
