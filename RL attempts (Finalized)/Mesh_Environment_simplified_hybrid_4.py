...
Hybrid reward function: Histogram + Mesh + String
    ...
    def calculate_reward(self, done, truncated):
        ...
        if done or truncated:
            ...
            if identical_to_initial:
                ...
                histogram_change = -time_step_penalty + 40 + mesh_distance + (40 - mse - string_distance)
        ...
        reward = - mse - string_distance + mesh_distance + time_step_penalty + histogram_change
