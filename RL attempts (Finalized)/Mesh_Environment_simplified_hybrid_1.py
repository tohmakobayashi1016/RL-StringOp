...
Hybrid reward function: Mesh + String
...
class MeshEnvironment(gym.Env):
    ...
    def calculate_reward(self, done, truncated):
        ...
        # Modify based on scope of interest
        ...
        if done or truncated:
            ...
            if identical_to_initial:
                ...
                histogram_change = -time_step_penalty + 15 + mesh_distance + (15-string_distance)
        ...
        reward = -string_distance + mesh_distance + time_step_penalty + histogram_change
