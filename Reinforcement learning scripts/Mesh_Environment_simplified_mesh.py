...
Topological feature: Mesh distance
...
class MeshEnvironment(gym.Env):
    ...
    def calculate_reward(self, done, truncated):
        ...
        mesh_distance = self.distance_calc.count_a_pairs(current_string)
        ...
        if done or truncated:
            ...
            if identical_to_initial:
                ...
                histogram_change = -time_step_penalty*self.max_steps + mesh_distance*self.max_steps
        ...
        reward = mesh_distance + time_step_penalty + histogram_change
