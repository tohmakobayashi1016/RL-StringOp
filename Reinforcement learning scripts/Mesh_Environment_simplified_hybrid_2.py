...
Hybrrid reward function: Mesh + Histogram
    ...
    def calculate_reward(self, done, truncated):
        ...
        if done or truncated:
            ...
            if identical_to_initial:
                ...
                histogram_change = -time_step_penalty + 15 + mesh_distance + (15-mse)
        ...
        reward = - mse + mesh_distance + time_step_penalty + histogram_change
